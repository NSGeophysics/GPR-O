function scr=hyperbScore(data,tp,v,xmax,linenr)
% hyperbScore(data,tp,v,xmax,linenr)
% 
% Calculates the sum of the values along a hyperbola to give a relative
...
%
% Last modified by plattner-at-alumni.ethz.ch, 01/16/2015
