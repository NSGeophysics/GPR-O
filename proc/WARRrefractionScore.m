function scr=WARRrefractionScore(data,tp,v,xmax,linenr)
% scr=WARRrefractionScore(data,tp,v,xmax,linenr)
% 
% Calculates the sum of the values along a refraction line over a WARR data set
% to give a relative value of how well the chosen velocity/depth-time refraction 
% fits the image
%
% INPUT:
%
