...
time-samples). Let's say that each measurement within the profile is 
...
wanted to export the data with AGC gain from the earlier example, run

\qquad \verb#gpro2vtk(dataHGa,0.06,0.2,0,'Exercise1Data',[]);#

Programs like Paraview offer powerful 3-D visualization to data.
