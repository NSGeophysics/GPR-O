...
Always before you use an Octave program for example by the name xyz,
run ``help xyz'' without the quotation marks to read about what input
is required and what the output will be.

For all GPR-O programs to run, your current directory (shown at the
top of your Octave program window) must be the GPR-O folder.
...
\qquad \verb#gpro2vtk# exports GPR-O data to a .vtk file, which can be
