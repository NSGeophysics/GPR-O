...
%\vspace{-0.5cm}
\begin{itemize}
\item \verb#nlines# The minimum line number
\item \verb#nmorelines# The number of lines after the minimum line number
...
first data file to call will have a value of ``0'' in the filename, such as ``XLine00''.
If the first line of your data set starts with, for example, ``XLine02'',
then you would enter a ``2'' instead.

The second line says ``surveyparams.nmorelines=23;'' which means that
GPR-O will search for 23 more data files after the initial one is found.
